...
class HentDagerTest {
    ...
    fun `Kun arbeidsgiverperiode`() {
        val utbetalingsdager =
            listOf(
                RSUtbetalingdag(mandag.plusDays(0), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(1), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(2), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(3), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(4), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(5), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(6), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(7), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(8), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(9), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
            )

        val forventetArbeidgiverDagliste =
            listOf(
                RSDag(mandag.plusDays(0), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(1), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(2), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(3), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(4), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(5), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(6), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
    ...
    @Test
    fun `Beholder grad selv om beløp er 0`() {
        val utbetalingsdager =
            listOf(
                RSUtbetalingdag(
    ...
    fun `Arbeidsgiverperiode oppbrukt`() {
        val utbetalingsdager =
            listOf(
                ...
                RSUtbetalingdag(mandag.plusDays(8), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(9), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(10), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(11), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(12), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(13), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(14), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(mandag.plusDays(15), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
        ...
        val forventetArbeidgiverDagliste =
            listOf(
                ...
                RSDag(mandag.plusDays(8), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(9), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(10), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(11), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(mandag.plusDays(12), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
    ...
    fun `Arbeidsgiverperiode blir oppbrukt på en søndag`() {
        ...
        val utbetalingsdager =
            listOf(
                RSUtbetalingdag(søndag.minusDays(15), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(14), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(13), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(12), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(11), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(10), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(9), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(8), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(7), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(6), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(5), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(4), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(3), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(2), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(1), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(søndag.minusDays(0), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
        ...
        val forventetArbeidgiverDagliste =
            listOf(
                RSDag(søndag.minusDays(15), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(14), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(13), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(12), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(11), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(10), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(9), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(8), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(7), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(6), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(5), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(4), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.minusDays(3), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
    ...
    fun `Arbeidsgiverperiode overtas av NAV og første dag er i helga`() {
        ...
        val utbetalingsdager =
            listOf(
                RSUtbetalingdag(søndag.plusDays(0), "ArbeidsgiverperiodeDag", emptyList(), sykdomsgrad = 100),
                RSUtbetalingdag(
                    søndag.plusDays(1),
                    "ArbeidsgiverperiodeDag",
                    emptyList(),
    ...
    fun `Både brukerutbetaling og arbeidsgiverrefusjon i arbeidsgiverperiode`() {
        ...
        val forventetArbeidsgiverDagliste =
            listOf(
                ...
                RSDag(søndag.plusDays(7), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(8), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(9), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(10), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(11), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(12), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(13), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(14), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(søndag.plusDays(15), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
            )

        val forventetSykmeldtDagliste =
            listOf(
                RSDag(søndag.plusDays(0), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
    ...
    fun `Både brukerutbetaling og arbeidsgiverrefusjon med mange utbetalingsperioder og ferie`() {
        ...
        val forventetArbeidsgiverDagliste =
            listOf(
                ...
                RSDag(dato.plusDays(6), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(7), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(8), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(9), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                ...
                RSDag(dato.plusDays(12), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(13), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(14), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
                RSDag(dato.plusDays(15), 0, 100.0, "ArbeidsgiverperiodeDag", emptyList()),
            )
