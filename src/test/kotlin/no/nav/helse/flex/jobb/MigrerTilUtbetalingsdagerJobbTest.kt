...
class MigrerTilUtbetalingsdagerJobbTest : FellesTestOppsett() {
    ...
    fun `burde migrere utbetaling med gammelt format til nytt format`() {
        ...
        utbetalingMigreringRepository.findFirst500ByStatus(MigrertStatus.MIGRERT).size `should be equal to` (1)
        utbetalingMigreringRepository.findFirst500ByStatus(MigrertStatus.IKKE_MIGRERT).size `should be equal to` (0)
